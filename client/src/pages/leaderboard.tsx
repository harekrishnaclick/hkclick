...
export default function LeaderboardPage({ user, t }: LeaderboardPageProps) {
  ...
  const myEntry = user
    ? activeList.find((e) => e.playerName === user.username)
    : null;
  ...
  const podiumColors = [
    { bg: 'podium-silver', text: '#c0c0c0', label: '🥈' },
    { bg: 'podium-gold', text: '#ffd700', label: '🥇' },
    { bg: 'podium-bronze', text: '#cd7f32', label: '🥉' },
  ];
  ...
  return (
    <div className="min-h-screen px-4 pt-10 pb-24 md:pb-8">
      <div className="max-w-2xl mx-auto md:max-w-none md:mx-0">
        ...
        >
          <div>
            <p className="text-[#d0c6ab] text-xs tracking-wider" style={{ fontFamily: 'Inter, sans-serif' }}>
              TOTAL GLOBAL MANTRAS
            </p>
            <p
              className="text-2xl font-bold text-[#ffd700] glow-gold"
              style={{ fontFamily: 'Sora, sans-serif' }}
            >
          ...
          <div className="flex gap-2 flex-wrap">
            <input
              ...
              style={{
                ...
                background: 'rgba(47,51,75,0.6)',
                border: '1px solid rgba(255,255,255,0.1)',
              }}
            />
            <input
              type="number"
              placeholder="Score (pairs)..."
              value={scoreInput}
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                background:
                  activeTab === id
                    ? 'linear-gradient(135deg, #e9c400, #ffd700)'
                    : 'rgba(47,51,75,0.5)',
        ...
        <div className="relative mb-5">
          <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-[#d0c6ab] text-xl">
            search
          </span>
          <input
            type="text"
        ...
        {loading ? (
          ...
          <div className="glass-card p-10 text-center">
            <span className="material-symbols-outlined text-5xl text-[#d0c6ab]/40 mb-3 block">
              leaderboard
            </span>
                ...
                {podiumOrder.map((entry, i) => {
                  ...
                  return (
                    <div
                      ...
                      style={{ marginBottom: rank === 1 ? '0' : '0' }}
                    >
                      {/* Avatar */}
                      <div
                        className="w-12 h-12 rounded-full flex items-center justify-center text-lg font-bold mb-2 flex-shrink-0"
                        style={{
                          background: `${color}25`,
                      ...
                      <p
                        className="text-[#fff6df] text-xs font-semibold text-center truncate w-full mb-0.5"
                        style={{ fontFamily: 'Sora, sans-serif' }}
                      >
                        {entry.playerName}
                      </p>
                      <p
                        className="text-[#d0c6ab] text-[11px] mb-2"
                        style={{ fontFamily: 'Inter, sans-serif' }}
                      >
                      ...
                      {/* Pedestal */}
                      <div
                        className={`w-full ${podiumHeights[i]} flex items-center justify-center rounded-t-lg text-xl ${pc.bg}`}
      ...
      {myEntry && myRank > 3 && user && (
        ...
        >
          <div className="flex items-center gap-3">
            <span
              className="text-[#ffd700] font-bold text-base w-8 text-center"
              style={{ fontFamily: 'Sora, sans-serif' }}
            >
              #{myRank}
            </span>
